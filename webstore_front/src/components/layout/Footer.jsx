      ...
      <div className="container">
        <div className="row justify-content-between align-items-center">
          <div className="col-md-4">
            <h2 className="logo fw-bold fs-4">
              <i className="bi bi-shop "></i> Web store
            </h2>
          </div>
          <div className="col-md-4">
            <ul className="nav justify-content-center">
              <li className="nav-item">
                <a href="/" className="nav-link text-white fw-bold fs-10">
                  Home
                </a>
              </li>
              <li className="nav-item">
                <a
                  href="/products"
                  className="nav-link text-white fw-bold fs-10"
                >
                  Products
                </a>
              </li>
